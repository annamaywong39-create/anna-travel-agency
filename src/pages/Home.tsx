      ...
      <section className="relative isolate overflow-hidden bg-[#0B1F3A] text-white">
        ...
        <div className="mx-auto grid min-h-[720px] max-w-7xl items-center gap-12 px-5 pb-20 pt-32 sm:px-8 lg:grid-cols-[1.05fr_.95fr] lg:px-12">
          <div className="max-w-2xl">
            <p className="mb-6 flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.28em] text-[#E6C98E]"><span className="h-px w-10 bg-[#D98C9B]" />Anna Travel Agency</p>
            <h1 className="max-w-xl text-5xl font-semibold leading-[1.05] tracking-[-0.04em] sm:text-7xl">Travel well for the moments that matter.</h1>
            <p className="mt-7 max-w-lg text-lg leading-8 text-white/70">Curated access to major events, paired with a stay that makes the journey feel effortless.</p>
          ...
          <div className="relative mx-auto w-full max-w-xl lg:ml-auto">
            ...
            <div className="relative overflow-hidden rounded-[2rem] bg-[#132A46] shadow-2xl shadow-black/30">
              <img src="/images/hero.jpg" alt="Travellers enjoying a destination" className="h-[430px] w-full object-cover opacity-90" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B1F3A] via-transparent to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-7"><p className="text-sm text-[#E6C98E]">The Anna approach</p><p className="mt-2 text-2xl font-medium leading-tight">One trip, thoughtfully put together.</p></div>
            </div>
          </div>
        </div>
      </section>
